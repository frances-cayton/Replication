...
```{r}
stargazer(coeftest(benchmarkPRI.1.proximity, covBMprox), coeftest(benchmarkPRI.1.distance, covBMdist), coeftest(benchmarkPRI.1.Quantile, covBMquantiles), coeftest(benchmarkPRI.1.Decile, covBMdeciles), coeftest(benchmarkPRI.1.log, covBMlogs), star.cutoffs = c(0.05, 0.01, 0.001),  digits=3)
```
