...
head(coeftest(benchmarkPRD.1.distance, vcov = vcovHC(benchmarkPRI.1.distance,type="HC1")))
head(coeftest(benchmarkPRD.1.distance))

head(coeftest(benchmarkPRD.1.Quantile, vcov = vcovHC(benchmarkPRI.1.Quantile,type="HC1")))
head(coeftest(benchmarkPRD.1.Quantile))
