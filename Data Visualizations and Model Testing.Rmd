...
marg<-marg(mod = g, var_interest = c("Distance.Cat"), type = 'levels', data=table[table$PRDstr==1 & table$highTURNOUT==1,],  cofint=.95)
...
dataPRI$distance<-(dataPRI$Distance.Cat)
```
